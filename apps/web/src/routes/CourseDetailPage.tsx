          ...
          <CardContent sx={{ p: 3 }}>
            {tab === 0 && (
              <Stack spacing={2}>
                ...
                <Meta
                  label="Delivery"
                  value={c.deliveryType === 'online' ? 'Online' : 'In person'}
                />
                ...
                />
                <Meta label="Seats" value={c.capacity == null ? 'Unlimited' : String(c.capacity)} />
                      ...
                      <ListItemText
                        ...
                        secondary={
                          <Stack direction="row" spacing={1} alignItems="center" sx={{ mt: 0.5 }}>
                            ...
                            <span>
                              {[s.venue, s.lecturer].filter(Boolean).join(' · ') || 'TBD'}
                            </span>
                          </Stack>
                        }
                      />
